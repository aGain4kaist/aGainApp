...
const CLOTHING_ITEMS = {
	1: [
		{ id: 1, userid:'name1', userprofile:'/images/profile.jpg', name: '옷 1', image: '/images/register4.jpg', description: '옷 설명 1', likes: 0 },
		{ id: 2, userid:'name2', userprofile:'/images/sample_profile_image.png', name: '옷 2', image: '/images/register4.jpg', description: '옷 설명 2', likes: 0 },
	],
	2: [
...
const dummyPost = {
  ...
  tags: ["test1", "test2"],
  duration: [2, "y"],
  image: "https://storage.googleapis.com/again-server-5156a.appspot.com/cloth/cloth1.jpg?GoogleAccessId=firebase-adminsdk-snbum%40again-server-5156a.iam.gserviceaccount.com&Expires=16731014400&Signature=YqI8oD3titl4iBtvOxYSdL74nNnQYfuR97wkeF%2B10E50UX3G5U2MtTFPt%2BFIxGlFylVp60h3JBD5OzTCe8YL2TsU9VzUN1LT1uMCyQGLdTEpdN94PZFJ%2FGmPWPHmZ8ZI82qaoq0Jg1FsIx7vHOAEQacdFGPOC%2BoEZrmgMSva0SJ8IvhsyXCvsW7AgTcPUk6TBoLotrcysC1ZrvJmfZlg%2B%2BV8kIBjQ4JgZlZjLB4crgWwXNE9Zkw3Wj8cNdhhOBwUWNJ6EYrlF0h5ETILtfEPDggn6Dtd1lgmPN82VvRMfOdX6%2Bbnx8Z4hA0A9a0G%2FncEVZRhdiZfO7DZJO61vEk5WA%3D%3D",
  name: "광인의 천옷",
  size: "170cm 60kg · 사이즈 적당함",
  height: 180,
  weight: 70,
  likes: 0,
  description: "힙하고 멋있어 보여서 작년에 망설임 없이 구매했는데 친구들이 자꾸 한문 선생님 같다고 놀려서 못 입겠어요",
...
function ClothingSearch() {
  ...
  return (
    <Flex direction="column" height="100vh" position="relative" bg="var(--background-silver, #FAF9FF)">
      ...
      <Flex direction="column" bg="var(--background-silver, #FAF9FF)" ml="25px" mb="10px">
        {/* 카테고리 선택 */}
      ...
      <Box p={0}> {/* padding을 0으로 설정하여 적용되지 않도록 합니다. */}
        <Swiper
          direction="vertical"
          spaceBetween={50}
          slidesPerView={1}
